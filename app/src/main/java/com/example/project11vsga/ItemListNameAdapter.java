package com.example.project11vsga;
...
import com.example.project11vsga.model.User;
...
public class ItemListNameAdapter extends RecyclerView.Adapter<ItemListNameAdapter.ItemViewHolder> {
    ...
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_item_list_name_adapter, parent, false);
